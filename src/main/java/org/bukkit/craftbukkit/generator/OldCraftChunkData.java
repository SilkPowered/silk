...
public final class OldCraftChunkData implements ChunkGenerator.ChunkData {
    ...
    private final Registry<net.minecraft.world.biome.Biome> biomes;
    private Set<BlockPos> tiles;
    private final Set<BlockPos> lights = new HashSet<>();

    public OldCraftChunkData(int minHeight, int maxHeight, Registry<net.minecraft.world.biome.Biome> biomes) {
