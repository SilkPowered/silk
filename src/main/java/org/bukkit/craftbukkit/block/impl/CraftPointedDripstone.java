...
public final class CraftPointedDripstone extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.PointedDripstone, org.bukkit.block.data.Waterlogged {
    ...
    private static final net.minecraft.state.property.EnumProperty<?> VERTICAL_DIRECTION = getEnum(net.minecraft.block.PointedDripstoneBlock.class, "vertical_direction");
    private static final net.minecraft.state.property.EnumProperty<?> THICKNESS = getEnum(net.minecraft.block.PointedDripstoneBlock.class, "thickness");
    ...
    private static final net.minecraft.state.property.BooleanProperty WATERLOGGED = getBoolean(net.minecraft.block.PointedDripstoneBlock.class, "waterlogged");
