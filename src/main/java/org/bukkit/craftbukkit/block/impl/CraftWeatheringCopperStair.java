...
public final class CraftWeatheringCopperStair extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.Stairs, org.bukkit.block.data.Bisected, org.bukkit.block.data.Directional, org.bukkit.block.data.Waterlogged {
    ...
    private static final net.minecraft.state.property.EnumProperty<?> SHAPE = getEnum(net.minecraft.block.OxidizableStairsBlock.class, "shape");
    ...
    private static final net.minecraft.state.property.EnumProperty<?> HALF = getEnum(net.minecraft.block.OxidizableStairsBlock.class, "half");
    ...
    private static final net.minecraft.state.property.EnumProperty<?> FACING = getEnum(net.minecraft.block.OxidizableStairsBlock.class, "facing");
    ...
    private static final net.minecraft.state.property.BooleanProperty WATERLOGGED = getBoolean(net.minecraft.block.OxidizableStairsBlock.class, "waterlogged");
