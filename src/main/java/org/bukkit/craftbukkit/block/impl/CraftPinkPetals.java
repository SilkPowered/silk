...
public final class CraftPinkPetals extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.PinkPetals, org.bukkit.block.data.Directional {
    ...
    public CraftPinkPetals(net.minecraft.block.BlockState state) {
        super(state);
    }

    // org.bukkit.craftbukkit.block.data.type.CraftPinkPetals

    private static final net.minecraft.state.property.IntProperty FLOWER_AMOUNT = getInteger(net.minecraft.block.FlowerbedBlock.class, "flower_amount");
    ...
    private static final net.minecraft.state.property.EnumProperty<?> FACING = getEnum(net.minecraft.block.FlowerbedBlock.class, "facing");
