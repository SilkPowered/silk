...
public final class CraftLayeredCauldron extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.Levelled {
    ...
    public CraftLayeredCauldron(net.minecraft.block.BlockState state) {
        super(state);
    }

    // org.bukkit.craftbukkit.block.data.CraftLevelled

    private static final net.minecraft.state.property.IntProperty LEVEL = getInteger(net.minecraft.block.LeveledCauldronBlock.class, "level");
