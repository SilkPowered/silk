...
public final class CraftCeilingHangingSign extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.HangingSign, org.bukkit.block.data.Attachable, org.bukkit.block.data.Rotatable, org.bukkit.block.data.Waterlogged {
    ...
    public CraftCeilingHangingSign(net.minecraft.block.BlockState state) {
        super(state);
    }

    // org.bukkit.craftbukkit.block.data.CraftAttachable

    private static final net.minecraft.state.property.BooleanProperty ATTACHED = getBoolean(net.minecraft.block.HangingSignBlock.class, "attached");
    ...
    private static final net.minecraft.state.property.IntProperty ROTATION = getInteger(net.minecraft.block.HangingSignBlock.class, "rotation");
    ...
    private static final net.minecraft.state.property.BooleanProperty WATERLOGGED = getBoolean(net.minecraft.block.HangingSignBlock.class, "waterlogged");
