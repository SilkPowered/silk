...
public final class CraftRedstoneWire extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.RedstoneWire, org.bukkit.block.data.AnaloguePowerable {
    ...
    private static final net.minecraft.state.property.EnumProperty<?> NORTH = getEnum(net.minecraft.block.RedstoneWireBlock.class, "north");
    private static final net.minecraft.state.property.EnumProperty<?> EAST = getEnum(net.minecraft.block.RedstoneWireBlock.class, "east");
    private static final net.minecraft.state.property.EnumProperty<?> SOUTH = getEnum(net.minecraft.block.RedstoneWireBlock.class, "south");
    private static final net.minecraft.state.property.EnumProperty<?> WEST = getEnum(net.minecraft.block.RedstoneWireBlock.class, "west");
    ...
    private static final net.minecraft.state.property.IntProperty POWER = getInteger(net.minecraft.block.RedstoneWireBlock.class, "power");
