...
public class CraftBlockEntityState<T extends BlockEntity> extends CraftBlockState implements TileState {
    ...
    private T createSnapshot(T tileEntity) {
        ...
        NbtCompound nbtTagCompound = tileEntity.createNbtWithIdentifyingData();
        T snapshot = (T) BlockEntity.createFromNbt(getPosition(), getHandle(), nbtTagCompound);
    ...
    private void copyData(T from, T to) {
        NbtCompound nbtTagCompound = from.createNbtWithIdentifyingData();
    ...
    public NbtCompound getSnapshotNBT() {
        ...
        return snapshot.createNbtWithIdentifyingData();
    }
    ...
    public Packet<ClientPlayPacketListener> getUpdatePacket(@NotNull Location location) {
        T vanillaTileEntitiy = (T) BlockEntity.createFromNbt(CraftLocation.toBlockPosition(location), getHandle(), getSnapshotNBT());
