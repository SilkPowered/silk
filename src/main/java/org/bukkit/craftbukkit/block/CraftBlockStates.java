...
public final class CraftBlockStates {
    ...
    private abstract static class BlockStateFactory<B extends CraftBlockState> {
        ...
        public abstract B createBlockState(World world, BlockPos blockPosition, net.minecraft.block.BlockState blockData, BlockEntity tileEntity);
    }
    ...
    static {
        ...
        register(
                ...
                ), CraftCommandBlock.class, CraftCommandBlock::new, CommandBlockBlockEntity::new
        );
        ...
        register(Material.END_GATEWAY, CraftEndGateway.class, CraftEndGateway::new, EndGatewayBlockEntity::new);
        register(Material.END_PORTAL, CraftEndPortal.class, CraftEndPortal::new, EndPortalBlockEntity::new);
        ...
        register(Material.MOVING_PISTON, CraftMovingPiston.class, CraftMovingPiston::new, PistonBlockEntity::new);
        ...
        register(Material.SPAWNER, CraftCreatureSpawner.class, CraftCreatureSpawner::new, MobSpawnerBlockEntity::new);
        register(Material.STRUCTURE_BLOCK, CraftStructureBlock.class, CraftStructureBlock::new, StructureBlockBlockEntity::new);
    ...
    private static <T extends BlockEntity, B extends CraftBlockEntityState<T>> void register(
            ...
            BiFunction<BlockPos, net.minecraft.block.BlockState, T> tileEntityConstructor
    ) {
    ...
    public static BlockEntity createNewTileEntity(Material material) {
        ...
        if (factory instanceof BlockEntityStateFactory) {
            return ((BlockEntityStateFactory<?, ?>) factory).createTileEntity(BlockPos.ZERO, CraftMagicNumbers.getBlock(material).getDefaultState());
        }
    ...
    public static BlockState getBlockState(Material material, @Nullable NbtCompound blockEntityTag) {
    ...
    public static BlockState getBlockState(BlockPos blockPosition, Material material, @Nullable NbtCompound blockEntityTag) {
        Preconditions.checkNotNull(material, "material is null");
        net.minecraft.block.BlockState blockData = CraftMagicNumbers.getBlock(material).getDefaultState();
    ...
    public static BlockState getBlockState(BlockPos blockPosition, net.minecraft.block.BlockState blockData, @Nullable NbtCompound blockEntityTag) {
        Preconditions.checkNotNull(blockPosition, "blockPosition is null");
        Preconditions.checkNotNull(blockData, "blockData is null");
        BlockEntity tileEntity = (blockEntityTag == null) ? null : BlockEntity.createFromNbt(blockPosition, blockData, blockEntityTag);
        return getBlockState(null, blockPosition, blockData, tileEntity);
    }

    // See BlockStateFactory#createBlockState(World, BlockPosition, IBlockData, TileEntity)
    private static CraftBlockState getBlockState(World world, BlockPos blockPosition, net.minecraft.block.BlockState blockData, BlockEntity tileEntity) {
