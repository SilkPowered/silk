...
public class CraftBlockState implements BlockState {
    ...
    public void setWorldHandle(WorldAccess generatorAccess) {
        if (generatorAccess instanceof net.minecraft.world.World) {
            this.weakWorld = null;
        } else {
    ...
    public WorldAccess getWorldHandle() {
        ...
        WorldAccess access = weakWorld.get();
        if (access == null) {
            weakWorld = null;
            return this.isPlaced() ? world.getHandle() : null;
        }
    ...
    public boolean update(boolean force, boolean applyPhysics) {
        ...
        WorldAccess access = getWorldHandle();
        ...
        if (false && applyPhysics && getData() instanceof Attachable) { // Call does not map to new API
            world.getHandle().updateNeighbors(position.offset(CraftBlock.blockFaceToNotch(((Attachable) getData()).getAttachedFace())), newBlock.getBlock());
        }
