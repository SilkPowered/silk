...
public abstract class CraftBed extends CraftBlockData implements Bed {
    ...
    private static final net.minecraft.state.property.EnumProperty<?> PART = getEnum("part");
    private static final net.minecraft.state.property.BooleanProperty OCCUPIED = getBoolean("occupied");
