...
public abstract class CraftRedstoneWire extends CraftBlockData implements RedstoneWire {
    ...
    private static final net.minecraft.state.property.EnumProperty<?> NORTH = getEnum("north");
    private static final net.minecraft.state.property.EnumProperty<?> EAST = getEnum("east");
    private static final net.minecraft.state.property.EnumProperty<?> SOUTH = getEnum("south");
    private static final net.minecraft.state.property.EnumProperty<?> WEST = getEnum("west");
