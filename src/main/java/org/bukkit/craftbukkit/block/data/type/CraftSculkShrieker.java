...
public abstract class CraftSculkShrieker extends CraftBlockData implements SculkShrieker {
    ...
    private static final net.minecraft.state.property.BooleanProperty CAN_SUMMON = getBoolean("can_summon");
    private static final net.minecraft.state.property.BooleanProperty SHRIEKING = getBoolean("shrieking");
