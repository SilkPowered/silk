...
public abstract class CraftPointedDripstone extends CraftBlockData implements PointedDripstone {
    ...
    private static final net.minecraft.state.property.EnumProperty<?> VERTICAL_DIRECTION = getEnum("vertical_direction");
    private static final net.minecraft.state.property.EnumProperty<?> THICKNESS = getEnum("thickness");
