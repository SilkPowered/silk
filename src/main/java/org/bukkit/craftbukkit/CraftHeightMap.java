    ...
    public static net.minecraft.world.Heightmap.Type toNMS(HeightMap bukkitHeightMap) {
        switch (bukkitHeightMap) {
            case MOTION_BLOCKING_NO_LEAVES:
                return net.minecraft.world.Heightmap.Type.MOTION_BLOCKING_NO_LEAVES;
            case OCEAN_FLOOR:
                return net.minecraft.world.Heightmap.Type.OCEAN_FLOOR;
            case OCEAN_FLOOR_WG:
                return net.minecraft.world.Heightmap.Type.OCEAN_FLOOR_WG;
            case WORLD_SURFACE:
                return net.minecraft.world.Heightmap.Type.WORLD_SURFACE;
            case WORLD_SURFACE_WG:
                return net.minecraft.world.Heightmap.Type.WORLD_SURFACE_WG;
            case MOTION_BLOCKING:
                return net.minecraft.world.Heightmap.Type.MOTION_BLOCKING;
            default:
                throw new EnumConstantNotPresentException(net.minecraft.world.Heightmap.Type.class, bukkitHeightMap.name());
        }
    }
