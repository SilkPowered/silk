...
public class CraftAllay extends CraftCreature implements org.bukkit.entity.Allay {
    ...
    public CraftAllay(CraftServer server, AllayEntity entity) {
        super(server, entity);
    }

    @Override
    public AllayEntity getHandle() {
        return (AllayEntity) entity;
    }
    ...
    public org.bukkit.entity.Allay duplicateAllay() {
        AllayEntity nmsAllay = getHandle().duplicateAllay();
