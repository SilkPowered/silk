...
public class CraftTropicalFish extends CraftFish implements TropicalFish {
    ...
    public DyeColor getPatternColor() {
        return getPatternColor(getHandle().getTropicalFishVariant());
    }

    @Override
    public void setPatternColor(DyeColor color) {
        getHandle().setTropicalFishVariant(getData(color, getBodyColor(), getPattern()));
    }

    @Override
    public DyeColor getBodyColor() {
        return getBodyColor(getHandle().getTropicalFishVariant());
    }

    @Override
    public void setBodyColor(DyeColor color) {
        getHandle().setTropicalFishVariant(getData(getPatternColor(), color, getPattern()));
    }

    @Override
    public Pattern getPattern() {
        return getPattern(getHandle().getTropicalFishVariant());
    }

    @Override
    public void setPattern(Pattern pattern) {
        getHandle().setTropicalFishVariant(getData(getPatternColor(), getBodyColor(), pattern));
    }
