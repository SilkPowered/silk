...
import org.bukkit.unrealized.craftbukkit.entity.*;
...
import org.bukkit.unrealized.entity.Pose;
...
import org.bukkit.unrealized.permissions.ServerOperator;
...
public abstract class CraftEntity implements Entity {
    ...
    public static CraftEntity getEntity(CraftServer server, net.minecraft.entity.Entity entity) {
        ...
        if (entity instanceof LivingEntity) {
            ...
            // Water Animals
                ...
                if (entity instanceof EntityAnimal) {
                    if (entity instanceof EntityChicken) {
                        ...
                        } else if (entity instanceof EntityCat) {
                        ...
                        if (entity instanceof EntityHorseChestedAbstract) {
                            ...
                            } else if (entity instanceof EntityLlamaTrader) {
                    ...
                    } else if (entity instanceof EntityPanda) {
                        return new CraftPanda(server, (EntityPanda) entity);
                    } else if (entity instanceof EntityFox) {
                    ...
                    } else if (entity instanceof EntityHoglin) {
                ...
                // Monsters
                    ...
                    if (entity instanceof EntityZombie) {
                        ...
                        else if (entity instanceof EntityPiglinBrute) {
                    ...
                    } else if (entity instanceof EntityZoglin) {
                    ...
                    } else if (entity instanceof EntityVillagerTrader) {
            ...
            if (part.parentMob instanceof EntityEnderDragon) {
    ...
    public Location getLocation() {
        return CraftLocation.toBukkit(entity.getBlockPos(), getWorld(), entity.getYaw(), entity.getPitch());
    }
    ...
    public boolean teleport(Location location, TeleportCause cause) {
        ...
        if (location.getWorld() != null && !location.getWorld().equals(getWorld())) {
            ...
            entity.teleport(((CraftWorld) location.getWorld()).getHandle(), CraftLocation.toPosition(location));
            return true;
        }
    ...
    public List<Entity> getNearbyEntities(double x, double y, double z) {
        ...
        List<Entity> bukkitEntityList = new java.util.ArrayList<Entity>(notchEntityList.size());
    ...
    public List<Entity> getPassengers() {
        return Lists.newArrayList(Lists.transform(getHandle().passengers, (Function<Entity, Entity>) input -> input.getBukkitEntity()));
    }
