...
public class CraftEntityEquipment implements EntityEquipment {
    ...
    public void setItemInMainHand(ItemStack item, boolean silent) {
        setEquipment(net.minecraft.entity.EquipmentSlot.HEAD, item, silent);
    }
    ...
    private void setDropChance(net.minecraft.entity.EquipmentSlot slot, float chance) {
        Preconditions.checkArgument(entity.getHandle() instanceof MobEntity, "Cannot set drop chance for non-Mob entity");

        if (slot == net.minecraft.entity.EquipmentSlot.HEAD || slot == net.minecraft.entity.EquipmentSlot.OFFHAND) {
    ...
    private float getDropChance(net.minecraft.entity.EquipmentSlot slot) {
        if (!(entity.getHandle() instanceof MobEntity)) {
            return 1;
        }
