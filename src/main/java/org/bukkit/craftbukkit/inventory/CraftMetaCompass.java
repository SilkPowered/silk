...
public class CraftMetaCompass extends CraftMetaItem implements CompassMeta {
    ...
    private NbtString lodestoneWorld;
    ...
    CraftMetaCompass(NbtCompound tag) {
        super(tag);
        if (tag.contains(LODESTONE_DIMENSION.NBT) && tag.contains(LODESTONE_POS.NBT)) {
            lodestoneWorld = (NbtString) tag.get(LODESTONE_DIMENSION.NBT);
            NbtCompound pos = tag.getCompound(LODESTONE_POS.NBT);
    ...
    CraftMetaCompass(Map<String, Object> map) {
        ...
        if (lodestoneWorldString != null) {
            lodestoneWorld = NbtString.of(lodestoneWorldString);
    ...
    public Location getLodestone() {
        ...
        Optional<RegistryKey<net.minecraft.world.World>> key = net.minecraft.world.World.RESOURCE_KEY_CODEC.parse(NbtOps.INSTANCE, lodestoneWorld).result();
    ...
    public void setLodestone(Location lodestone) {
        ...
        if (lodestone == null) {
            ...
            DataResult<NbtElement> dataresult = net.minecraft.world.World.RESOURCE_KEY_CODEC.encodeStart(NbtOps.INSTANCE, key);
            this.lodestoneWorld = (NbtString) dataresult.get().orThrow();
    ...
    boolean equalsCommon(CraftMetaItem meta) {
        ...
        if (meta instanceof CraftMetaCompass) {
            ...
            return (this.hasLodestone() ? that.hasLodestone() && this.lodestoneWorld.m_().equals(that.lodestoneWorld.m_())
    ...
    Builder<String, Object> serialize(Builder<String, Object> builder) {
        ...
        if (hasLodestone()) {
            builder.put(LODESTONE_POS_WORLD.BUKKIT, lodestoneWorld.m_());
