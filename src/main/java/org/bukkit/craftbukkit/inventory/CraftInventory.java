...
public class CraftInventory implements Inventory {
    ...
    public InventoryType getType() {
        ...
        } else if (inventory instanceof ComposterBlock.DummyInventory || inventory instanceof ComposterBlock.ComposterInventory || inventory instanceof ComposterBlock.FullComposterInventory) {
