...
public final class CraftLegacy {
    ...
    static {
        ...
        if (IMinecraftServerMixin.getServer() != null && IMinecraftServerMixin.getServer().isDebugRunning()) {
        ...
        for (Material material : Material.values()) {
            ...
            for (byte data = 0; data < maxData; data++) {
                ...
                Dynamic<NbtElement> converted = Schemas.getFixer().update(TypeReferences.ITEM_STACK, new Dynamic<>(NbtOps.INSTANCE, stack), -1, CraftMagicNumbers.INSTANCE.getDataVersion());
