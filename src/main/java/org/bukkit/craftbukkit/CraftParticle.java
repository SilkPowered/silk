...
public enum CraftParticle {
    ...
    public static <T> ParticleEffect toNMS(Particle particle, T obj) {
        ...
        if (particle.getDataType() == Particle.DustOptions.class) {
            ...
            return new DustParticleEffect(new Vector3f(color.getRed() / 255.0f, color.getGreen() / 255.0f, color.getBlue() / 255.0f), data.getSize());
        }
        if (particle.getDataType() == Particle.DustTransition.class) {
            ...
            return new DustColorTransitionParticleEffect(new Vector3f(from.getRed() / 255.0f, from.getGreen() / 255.0f, from.getBlue() / 255.0f), new Vector3f(to.getRed() / 255.0f, to.getGreen() / 255.0f, to.getBlue() / 255.0f), data.getSize());
        }
        if (particle.getDataType() == Vibration.class) {
            ...
            return new VibrationParticleEffect(source, vibration.getArrivalTime());
        }
        if (particle.getDataType() == Float.class) {
            return new SculkChargeParticleEffect((Float) obj);
        }
        if (particle.getDataType() == Integer.class) {
            return new ShriekParticleEffect((Integer) obj);
        }
