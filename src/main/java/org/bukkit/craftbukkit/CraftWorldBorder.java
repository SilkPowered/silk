...
public class CraftWorldBorder implements WorldBorder {
    ...
    @Override
    public void reset() {
        this.getHandle().applySettings(net.minecraft.world.border.WorldBorder.DEFAULT_SETTINGS);
    }
    ...
    public double getMaxSize() {
        return net.minecraft.world.border.WorldBorder.MAX_SIZE;
    }

    @Override
    public double getMaxCenterCoordinate() {
        return net.minecraft.world.border.WorldBorder.MAX_CENTER_COORDINATE;
    }

    public net.minecraft.world.border.WorldBorder getHandle() {
        return handle;
    }
