...
public final class CraftChatMessage {
    ...
    private static Text fixComponent(MutableText component, Matcher matcher) {
        if (component.b() instanceof LiteralTextContent) {
            LiteralTextContent text = ((LiteralTextContent) component.b());
            String msg = text.string();
            if (matcher.reset(msg).find()) {
                matcher.reset();

                Style modifier = component.a();
                List<Text> extras = new ArrayList<Text>();
                List<Text> extrasOld = new ArrayList<Text>(component.c());
        ...
        if (component.b() instanceof TranslatableTextContent) {
            Object[] subs = ((TranslatableTextContent) component.b()).getArgs();
