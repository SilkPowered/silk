...
public class CraftSound {
    ...
    public static SoundEvent getSoundEffect(Sound s) {
        SoundEvent effect = Registries.SOUND_EVENT.get(CraftNamespacedKey.toMinecraft(s.getKey()));
        Preconditions.checkArgument(effect != null, "Sound effect %s does not exist", s);
    ...
    public static Sound getBukkit(SoundEvent soundEffect) {
        return Registry.SOUNDS.get(CraftNamespacedKey.fromMinecraft(Registries.SOUND_EVENT.getId(soundEffect)));
    }
}
