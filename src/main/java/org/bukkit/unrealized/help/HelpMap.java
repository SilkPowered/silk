package org.bukkit.unrealized.help;
...
public interface HelpMap {
     ...
     * PluginCommand} who's executor derives from {@code
     * commandClass} base class.
     *
     * @param commandClass The class for which the custom HelpTopicFactory
     *     applies. Must derive from either {@link Command}
     *     or {@link CommandExecutor}.
     ...
     * {@link Command} instead of {@link
     * PluginCommand} will need to check this collection in
