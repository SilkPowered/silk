...
import org.bukkit.unrealized.TreeSpecies;
...
public class Wood extends MaterialData {
    ...
    public TreeSpecies getSpecies() {
        switch (getItemType()) {
            case Material.LEGACY_WOOD:
            case Material.LEGACY_WOOD_DOUBLE_STEP:
                return TreeSpecies.getByData((byte) getData());
            case Material.LEGACY_LOG:
            case Material.LEGACY_LEAVES:
                return TreeSpecies.getByData((byte) (getData() & 0x3));
            case Material.LEGACY_LOG_2:
            case Material.LEGACY_LEAVES_2:
                return TreeSpecies.getByData((byte) ((getData() & 0x3) | 0x4));
            case Material.LEGACY_SAPLING:
            case Material.LEGACY_WOOD_STEP:
