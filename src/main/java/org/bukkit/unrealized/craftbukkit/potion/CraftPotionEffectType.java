package org.bukkit.unrealized.craftbukkit.potion;
...
public class CraftPotionEffectType extends PotionEffectType {
    ...
    public CraftPotionEffectType(MobEffectList handle) {
        super(MobEffectList.getId(handle), CraftNamespacedKey.fromMinecraft(BuiltInRegistries.MOB_EFFECT.getKey(handle)));
        this.handle = handle;
    }
