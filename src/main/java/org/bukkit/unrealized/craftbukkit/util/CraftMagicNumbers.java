...
import org.bukkit.unrealized.craftbukkit.CraftFeatureFlag;
import org.bukkit.unrealized.craftbukkit.attribute.CraftAttributeInstance;
import org.bukkit.unrealized.craftbukkit.attribute.CraftAttributeMap;
import org.bukkit.unrealized.craftbukkit.block.data.CraftBlockData;
import org.bukkit.craftbukkit.inventory.CraftItemStack;
import org.bukkit.unrealized.craftbukkit.legacy.CraftLegacy;
...
import org.bukkit.unrealized.plugin.InvalidPluginException;
import org.bukkit.unrealized.plugin.PluginDescriptionFile;
...
public final class CraftMagicNumbers implements UnsafeValues {
    ...
    public static IBlockData getBlock(Material material, byte data) {
        return org.bukkit.unrealized.craftbukkit.legacy.CraftLegacy.fromLegacyData(org.bukkit.unrealized.craftbukkit.legacy.CraftLegacy.toLegacy(material), data);
    }

    public static MaterialData getMaterial(IBlockData data) {
        return org.bukkit.unrealized.craftbukkit.legacy.CraftLegacy.toLegacy(getMaterial(data.getBlock())).getNewData(toLegacyData(data));
    }
    ...
    public static MaterialData getMaterialData(Item item) {
        return org.bukkit.unrealized.craftbukkit.legacy.CraftLegacy.toLegacyData(getMaterial(item));
    }
    ...
    public static Item getItem(Material material) {
        if (material != null && material.isLegacy()) {
            material = org.bukkit.unrealized.craftbukkit.legacy.CraftLegacy.fromLegacy(material);
        }
    ...
    public static byte toLegacyData(IBlockData data) {
        return org.bukkit.unrealized.craftbukkit.legacy.CraftLegacy.toLegacyData(data);
    }

    @Override
    public Material toLegacy(Material material) {
        return org.bukkit.unrealized.craftbukkit.legacy.CraftLegacy.toLegacy(material);
    }
    ...
    public Material fromLegacy(MaterialData material, boolean itemPriority) {
        return org.bukkit.unrealized.craftbukkit.legacy.CraftLegacy.fromLegacy(material, itemPriority);
    }
