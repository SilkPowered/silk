...
import org.bukkit.unrealized.plugin.AuthorNagException;
...
public class Commodore
{
    ...
    private static final Set<String> EVIL = new HashSet<>( Arrays.asList(
            "org/bukkit/unrealized/World (III)I getBlockTypeIdAt",
            "org/bukkit/unrealized/World (Lorg/bukkit/Location;)I getBlockTypeIdAt",
            "org/bukkit/unrealized/block/Block ()I getTypeId",
            "org/bukkit/unrealized/block/Block (I)Z setTypeId",
            "org/bukkit/unrealized/block/Block (IZ)Z setTypeId",
            "org/bukkit/unrealized/block/Block (IBZ)Z setTypeIdAndData",
            "org/bukkit/unrealized/block/Block (B)V setData",
            "org/bukkit/unrealized/block/Block (BZ)V setData",
            "org/bukkit/unrealized/inventory/ItemStack ()I getTypeId",
            "org/bukkit/unrealized/inventory/ItemStack (I)V setTypeId"
    ) );
        ...
        cr.accept( new ClassVisitor( Opcodes.ASM9, cw )
        {
            ...
            public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions)
            {
                return new MethodVisitor( api, super.visitMethod( access, name, desc, signature, exceptions ) )
                {
                    ...
                    {
                        if ( owner.equals("org/bukkit/unrealized/block/Biome") )
                        {
                            switch ( name )
                            {
                                case "NETHER":
                        ...
                        if ( owner.equals("org/bukkit/unrealized/entity/EntityType") )
                        {
                            switch ( name )
                            {
                                case "PIG_ZOMBIE":
                        ...
                        if ( owner.equals("org/bukkit/unrealized/loot/LootTables") )
                        {
                            switch ( name )
                            {
                                case "ZOMBIE_PIGMAN":
                        ...
                        // SPIGOT-7335
                        if ( owner.equals("org/bukkit/unrealized/entity/TextDisplay$TextAligment") )
                        {
                            super.visitFieldInsn( opcode, "org/bukkit/unrealized/entity/TextDisplay$TextAlignment", name, desc );
                            return;
                        }

                        if ( modern )
                        {
                            if ( owner.equals("org/bukkit/unrealized/Material") )
                            {
                                switch ( name )
                                {
                                    case "CACTUS_GREEN":
                        ...
                        if ( owner.equals("org/bukkit/unrealized/Art") )
                        {
                            switch ( name )
                            {
                                case "BURNINGSKULL":
                        ...
                        if ( owner.equals("org/bukkit/unrealized/DyeColor") )
                        {
                            switch ( name )
                            {
                                case "SILVER":
                        ...
                        if ( owner.equals("org/bukkit/unrealized/Particle") )
                        {
                            switch ( name )
                            {
                                case "BLOCK_CRACK":
                    ...
                    {
                        // SPIGOT-4496
                        if ( owner.equals("org/bukkit/unrealized/map/MapView") && name.equals( "getId" ) && desc.equals( "()S" ) )
                        {
                        ...
                        // SPIGOT-4608
                        if ( (owner.equals("org/bukkit/unrealized/Bukkit") || owner.equals("org/bukkit/unrealized/Server") ) && name.equals( "getMap" ) && desc.equals( "(S)Lorg/bukkit/map/MapView;" ) )
                        {
                            // Should be same size on stack so just call other method
                        ...
                        if ( owner.equals("org/bukkit/unrealized/entity/TextDisplay$TextAligment") )
                        {
                            super.visitMethodInsn( opcode, "org/bukkit/unrealized/entity/TextDisplay$TextAlignment", name, desc, itf );
                            return;
                        }
                        ...
                        if ( modern )
                        {
                            if ( owner.equals("org/bukkit/unrealized/Material") )
                            {
                                ...
                                {
                                    case "values":
                                        super.visitMethodInsn( opcode, "org/bukkit/unrealized/craftbukkit/util/CraftLegacy", "modern_" + name, desc, itf );
                                        return;
                                    case "ordinal":
                                        super.visitMethodInsn( Opcodes.INVOKESTATIC, "org/bukkit/unrealized/craftbukkit/util/CraftLegacy", "modern_" + name, "(Lorg/bukkit/Material;)I", false );
                                        return;
                                }
                            }
                        ...
                        if ( owner.equals("org/bukkit/unrealized/ChunkSnapshot") && name.equals( "getBlockData" ) && desc.equals( "(III)I" ) )
                        {
                        ...
                        if ( EVIL.contains( owner + " " + desc + " " + name )
                                || ( owner.startsWith("org/bukkit/unrealized/block/") && ( desc + " " + name ).equals( "()I getTypeId" ) )
                                || ( owner.startsWith("org/bukkit/unrealized/block/") && ( desc + " " + name ).equals( "(I)Z setTypeId" ) )
                                || ( owner.startsWith("org/bukkit/unrealized/block/") && ( desc + " " + name ).equals( "()Lorg/bukkit/Material; getType" ) ) )
                        {
                            ...
                            super.visitMethodInsn( Opcodes.INVOKESTATIC, "org/bukkit/unrealized/craftbukkit/legacy/CraftEvil", name, Type.getMethodDescriptor( retType, newArgs ), false );
                            return;
                        }
                        ...
                        if ( owner.equals("org/bukkit/unrealized/Material") )
                        {
                            ...
                            {
                                super.visitMethodInsn( opcode, "org/bukkit/unrealized/craftbukkit/legacy/CraftEvil", name, desc, itf );
                                return;
                            }
                            ...
                            switch ( name )
                            {
                                ...
                                case "getMaterial":
                                case "matchMaterial":
                                    super.visitMethodInsn( opcode, "org/bukkit/unrealized/craftbukkit/legacy/CraftLegacy", name, desc, itf );
                                    return;
                                case "ordinal":
                                    super.visitMethodInsn( Opcodes.INVOKESTATIC, "org/bukkit/unrealized/craftbukkit/legacy/CraftLegacy", "ordinal", "(Lorg/bukkit/Material;)I", false );
                                    return;
                                case "name":
                                case "toString":
                                    super.visitMethodInsn( Opcodes.INVOKESTATIC, "org/bukkit/unrealized/craftbukkit/legacy/CraftLegacy", name, "(Lorg/bukkit/Material;)Ljava/lang/String;", false );
                                    return;
                            }
                        }

                        if ( retType.getSort() == Type.OBJECT && retType.getInternalName().equals("org/bukkit/unrealized/Material") && owner.startsWith("org/bukkit/unrealized") )
                        {
                            super.visitMethodInsn( opcode, owner, name, desc, itf );
                            super.visitMethodInsn( Opcodes.INVOKESTATIC, "org/bukkit/unrealized/craftbukkit/legacy/CraftLegacy", "toLegacy", "(Lorg/bukkit/Material;)Lorg/bukkit/Material;", false );
                            return;
                        }
