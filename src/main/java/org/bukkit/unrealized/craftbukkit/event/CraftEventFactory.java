package org.bukkit.unrealized.craftbukkit.event;
...
import org.bukkit.unrealized.Statistic.Type;
...
import org.bukkit.unrealized.block.CreatureSpawner;
import org.bukkit.unrealized.craftbukkit.CraftChunk;
import org.bukkit.unrealized.craftbukkit.CraftEquipmentSlot;
import org.bukkit.unrealized.craftbukkit.CraftLootTable;
import org.bukkit.unrealized.craftbukkit.CraftRaid;
...
import org.bukkit.unrealized.craftbukkit.entity.CraftRaider;
import org.bukkit.unrealized.craftbukkit.entity.CraftSpellcaster;
import org.bukkit.unrealized.craftbukkit.inventory.CraftInventoryCrafting;
import org.bukkit.craftbukkit.inventory.CraftItemStack;
import org.bukkit.unrealized.craftbukkit.inventory.CraftMetaBook;
...
import org.bukkit.unrealized.entity.Animals;
...
import org.bukkit.unrealized.entity.Raider;
...
import org.bukkit.unrealized.entity.Villager.Profession;
import org.bukkit.unrealized.event.Cancellable;
import org.bukkit.unrealized.event.Event;
import org.bukkit.unrealized.event.Event.Result;
import org.bukkit.unrealized.event.block.Action;
import org.bukkit.unrealized.event.block.BellResonateEvent;
import org.bukkit.unrealized.event.block.BellRingEvent;
import org.bukkit.unrealized.event.block.BlockDamageAbortEvent;
import org.bukkit.unrealized.event.block.BlockDamageEvent;
import org.bukkit.unrealized.event.block.BlockDropItemEvent;
import org.bukkit.unrealized.event.block.BlockFadeEvent;
import org.bukkit.unrealized.event.block.BlockFormEvent;
import org.bukkit.unrealized.event.block.BlockGrowEvent;
import org.bukkit.unrealized.event.block.BlockIgniteEvent;
import org.bukkit.unrealized.event.block.BlockIgniteEvent.IgniteCause;
import org.bukkit.unrealized.event.block.BlockMultiPlaceEvent;
import org.bukkit.unrealized.event.block.BlockPhysicsEvent;
import org.bukkit.unrealized.event.block.BlockPlaceEvent;
import org.bukkit.unrealized.event.block.BlockRedstoneEvent;
import org.bukkit.unrealized.event.block.BlockShearEntityEvent;
import org.bukkit.unrealized.event.block.BlockSpreadEvent;
import org.bukkit.unrealized.event.block.EntityBlockFormEvent;
import org.bukkit.unrealized.event.block.FluidLevelChangeEvent;
import org.bukkit.unrealized.event.block.MoistureChangeEvent;
import org.bukkit.unrealized.event.block.NotePlayEvent;
import org.bukkit.unrealized.event.block.TNTPrimeEvent;
import org.bukkit.unrealized.event.entity.AreaEffectCloudApplyEvent;
import org.bukkit.unrealized.event.entity.ArrowBodyCountChangeEvent;
import org.bukkit.unrealized.event.entity.BatToggleSleepEvent;
...
import org.bukkit.unrealized.event.entity.CreeperPowerEvent;
import org.bukkit.unrealized.event.entity.EntityBreakDoorEvent;
import org.bukkit.unrealized.event.entity.EntityBreedEvent;
import org.bukkit.unrealized.event.entity.EntityChangeBlockEvent;
import org.bukkit.unrealized.event.entity.EntityDamageByBlockEvent;
import org.bukkit.unrealized.event.entity.EntityDamageByEntityEvent;
import org.bukkit.unrealized.event.entity.EntityDamageEvent;
import org.bukkit.unrealized.event.entity.EntityDamageEvent.DamageCause;
import org.bukkit.unrealized.event.entity.EntityDamageEvent.DamageModifier;
import org.bukkit.unrealized.event.entity.EntityDeathEvent;
import org.bukkit.unrealized.event.entity.EntityEnterLoveModeEvent;
import org.bukkit.unrealized.event.entity.EntityExhaustionEvent;
import org.bukkit.unrealized.event.entity.EntityPickupItemEvent;
import org.bukkit.unrealized.event.entity.EntityPlaceEvent;
import org.bukkit.unrealized.event.entity.EntityPotionEffectEvent;
import org.bukkit.unrealized.event.entity.EntityShootBowEvent;
import org.bukkit.unrealized.event.entity.EntitySpawnEvent;
import org.bukkit.unrealized.event.entity.EntitySpellCastEvent;
import org.bukkit.unrealized.event.entity.EntityTameEvent;
import org.bukkit.unrealized.event.entity.EntityTargetEvent;
import org.bukkit.unrealized.event.entity.EntityTargetLivingEntityEvent;
import org.bukkit.unrealized.event.entity.EntityToggleGlideEvent;
import org.bukkit.unrealized.event.entity.EntityToggleSwimEvent;
import org.bukkit.unrealized.event.entity.EntityTransformEvent;
import org.bukkit.unrealized.event.entity.ExpBottleEvent;
import org.bukkit.unrealized.event.entity.FireworkExplodeEvent;
import org.bukkit.unrealized.event.entity.FoodLevelChangeEvent;
import org.bukkit.unrealized.event.entity.HorseJumpEvent;
import org.bukkit.unrealized.event.entity.ItemDespawnEvent;
import org.bukkit.unrealized.event.entity.ItemMergeEvent;
import org.bukkit.unrealized.event.entity.ItemSpawnEvent;
import org.bukkit.unrealized.event.entity.LingeringPotionSplashEvent;
import org.bukkit.unrealized.event.entity.PigZapEvent;
import org.bukkit.unrealized.event.entity.PiglinBarterEvent;
import org.bukkit.unrealized.event.entity.PlayerDeathEvent;
import org.bukkit.unrealized.event.entity.PlayerLeashEntityEvent;
import org.bukkit.unrealized.event.entity.PotionSplashEvent;
import org.bukkit.unrealized.event.entity.ProjectileHitEvent;
import org.bukkit.unrealized.event.entity.ProjectileLaunchEvent;
import org.bukkit.unrealized.event.entity.SpawnerSpawnEvent;
import org.bukkit.unrealized.event.entity.StriderTemperatureChangeEvent;
import org.bukkit.unrealized.event.entity.VillagerCareerChangeEvent;
import org.bukkit.unrealized.event.inventory.InventoryCloseEvent;
import org.bukkit.unrealized.event.inventory.InventoryOpenEvent;
import org.bukkit.unrealized.event.inventory.PrepareAnvilEvent;
import org.bukkit.unrealized.event.inventory.PrepareGrindstoneEvent;
import org.bukkit.unrealized.event.inventory.PrepareItemCraftEvent;
import org.bukkit.unrealized.event.inventory.PrepareSmithingEvent;
import org.bukkit.unrealized.event.inventory.TradeSelectEvent;
import org.bukkit.unrealized.event.player.PlayerBedEnterEvent;
import org.bukkit.unrealized.event.player.PlayerBedEnterEvent.BedEnterResult;
import org.bukkit.unrealized.event.player.PlayerBucketEmptyEvent;
import org.bukkit.unrealized.event.player.PlayerBucketEntityEvent;
import org.bukkit.unrealized.event.player.PlayerBucketFillEvent;
import org.bukkit.unrealized.event.player.PlayerBucketFishEvent;
import org.bukkit.unrealized.event.player.PlayerEditBookEvent;
import org.bukkit.unrealized.event.player.PlayerEvent;
import org.bukkit.unrealized.event.player.PlayerExpChangeEvent;
import org.bukkit.unrealized.event.player.PlayerExpCooldownChangeEvent;
import org.bukkit.unrealized.event.player.PlayerHarvestBlockEvent;
import org.bukkit.unrealized.event.player.PlayerInteractEvent;
import org.bukkit.unrealized.event.player.PlayerItemBreakEvent;
import org.bukkit.unrealized.event.player.PlayerItemMendEvent;
import org.bukkit.unrealized.event.player.PlayerLevelChangeEvent;
import org.bukkit.unrealized.event.player.PlayerRecipeDiscoverEvent;
import org.bukkit.unrealized.event.player.PlayerShearEntityEvent;
import org.bukkit.unrealized.event.player.PlayerStatisticIncrementEvent;
import org.bukkit.unrealized.event.player.PlayerUnleashEntityEvent;
import org.bukkit.unrealized.event.raid.RaidFinishEvent;
import org.bukkit.unrealized.event.raid.RaidSpawnWaveEvent;
import org.bukkit.unrealized.event.raid.RaidStopEvent;
import org.bukkit.unrealized.event.raid.RaidTriggerEvent;
import org.bukkit.unrealized.event.server.ServerListPingEvent;
import org.bukkit.unrealized.event.vehicle.VehicleCreateEvent;
import org.bukkit.unrealized.event.weather.LightningStrikeEvent;
import org.bukkit.unrealized.event.world.EntitiesLoadEvent;
import org.bukkit.unrealized.event.world.EntitiesUnloadEvent;
import org.bukkit.unrealized.event.world.LootGenerateEvent;
...
import org.bukkit.unrealized.inventory.meta.BookMeta;
...
public class CraftEventFactory {
    ...
    public static PlayerHarvestBlockEvent callPlayerHarvestBlockEvent(World world, BlockPosition blockposition, EntityHuman who, EnumHand enumhand, List<ItemStack> itemsToHarvest) {
        List<ItemStack> bukkitItemsToHarvest = new ArrayList<>(itemsToHarvest.stream().map(CraftItemStack::asBukkitCopy).collect(Collectors.toList()));
    ...
    public static PlayerItemMendEvent callPlayerItemMendEvent(EntityHuman entity, EntityExperienceOrb orb, net.minecraft.world.item.ItemStack nmsMendedItem, EnumItemSlot slot, int repairAmount) {
        Player player = (Player) entity.getBukkitEntity();
        ItemStack bukkitStack = CraftItemStack.asCraftMirror(nmsMendedItem);
    ...
    public static BlockIgniteEvent callBlockIgniteEvent(World world, int x, int y, int z, Explosion explosion) {
        World bukkitWorld = world.getWorld();
        Entity igniter = explosion.source == null ? null : explosion.source.getBukkitEntity();
    ...
    public static LootGenerateEvent callLootGenerateEvent(IInventory inventory, LootTable lootTable, LootTableInfo lootInfo, List<ItemStack> loot, boolean plugin) {
        ...
        List<ItemStack> bukkitLoot = loot.stream().map(CraftItemStack::asCraftMirror).collect(Collectors.toCollection(ArrayList::new));
    ...
    public static void callEntitiesLoadEvent(World world, ChunkCoordIntPair coords, List<Entity> entities) {
        List<Entity> bukkitEntities = Collections.unmodifiableList(entities.stream().map(Entity::getBukkitEntity).collect(Collectors.toList()));
    ...
    public static boolean callTNTPrimeEvent(World world, BlockPosition pos, TNTPrimeEvent.PrimeCause cause, Entity causingEntity, BlockPosition causePosition) {
        Entity bukkitEntity = (causingEntity == null) ? null : causingEntity.getBukkitEntity();
