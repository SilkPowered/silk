...
public class PlayerLoginEvent extends PlayerEvent {
    ...
    private org.bukkit.event.player.PlayerLoginEvent.Result result = org.bukkit.event.player.PlayerLoginEvent.Result.ALLOWED;
     ...
     * @param realAddress the actual, unspoofed connecting address
     */
    public PlayerLoginEvent(@NotNull final Player player, @NotNull String hostname, @NotNull final InetAddress address, @NotNull final org.bukkit.event.player.PlayerLoginEvent.Result result, @NotNull final String message, @NotNull final InetAddress realAddress) { // Spigot
     ...
     */
    public void setResult(@NotNull final org.bukkit.event.player.PlayerLoginEvent.Result result) {
        this.result = result;
    }
     ...
     */
    public void disallow(@NotNull final org.bukkit.event.player.PlayerLoginEvent.Result result, @NotNull final String message) {
        this.result = result;
        this.message = message;
    }
