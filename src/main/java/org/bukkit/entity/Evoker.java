...
public interface Evoker extends Spellcaster {
    ...
    /**
     * Gets the {@link org.bukkit.entity.Evoker.Spell} the Evoker is currently using.
     *
    ...
    @Deprecated
    @NotNull
    org.bukkit.entity.Evoker.Spell getCurrentSpell();

    /**
     * Sets the {@link org.bukkit.entity.Evoker.Spell} the Evoker is currently using.
     *
     ...
     */
    @Deprecated
    void setCurrentSpell(@Nullable org.bukkit.entity.Evoker.Spell spell);
}
